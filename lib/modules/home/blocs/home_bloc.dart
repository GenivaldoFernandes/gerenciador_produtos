  ...
  void preenchimentoAltBase() {
    ...
    b.forEach((element) {
      var produto = Produto(
          ...
          nome: element['name'],
          preco: (!element['regular_price'].toString().isEmpty) ? double.parse(element['regular_price'].toString().replaceAll(',', '.')) : 0,
          precoPromocao: (!element['actual_price'].toString().isEmpty) ? double.parse(element['actual_price'].toString().replaceAll(',', '.')) : 0,
          percentualDesconto: (!element['discount_percentage'].toString().isEmpty) ? double.parse(element['discount_percentage'].toString().replaceAll('%', '')) : 0,
          disponivelVenda: (element['on_sale']) ? 1 : 0
      );
      create(produto);
    });
  }
  ...
  List base () {
    return [
      ...
      },
      {
        ...
        "color": "OFF-WHITE",
        "on_sale": false,
        "regular_price": "239,90",
        "actual_price": "239,90",
        "discount_percentage": "",
        "installments": "3x 79,97",
